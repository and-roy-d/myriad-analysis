...
modflist = np.logspace(np.log10(freq_start), np.log10(freq_end), 200)

#modampl_fact = [10, 10, 10, 10, 5, 1, 1, 1, 1, 1]
modampl_fact = np.ones_like(modflist)
modampl_fact[modflist > 10e3] = 10

pltlist = [] #indices of frequencies to plot
...
# Save cz data
#
fname = '%s/cz_%s_105mK_3.0Vb.npz' % (cfg.cz_dir, cfg.date_time_str)
